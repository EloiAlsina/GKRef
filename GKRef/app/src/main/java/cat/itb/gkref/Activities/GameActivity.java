...
public class GameActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        local_2m_timer1=findViewById(R.id.local_2m_timer1);
        local_2m_timer2=findViewById(R.id.local_2m_timer2);
        visitor_2m_timer1=findViewById(R.id.visitor_2m_timer1);
        visitor_2m_timer2=findViewById(R.id.visitor_2m_timer2);

        local_yc=findViewById(R.id.local_yc);
        local_rc=findViewById(R.id.local_rc);
        visitor_yc=findViewById(R.id.visitor_yc);
        visitor_rc=findViewById(R.id.visitor_rc);

        exclusion_local=findViewById(R.id.exclusion_local);
        exclusion_visitor=findViewById(R.id.exclusion_visitor);
        ...
        local_down = findViewById(R.id.local_down);
        local_up = findViewById(R.id.local_up);

        timeout_countdown_local=findViewById(R.id.timeout_countdown_local);
        timeout_countdown_visitor=findViewById(R.id.timeout_countdown_visitor);

        timeout_local = findViewById(R.id.timeout_local);
        timeout_visitor = findViewById(R.id.timeout_visitor);

        visitor_down = findViewById(R.id.visitor_down);
        visitor_up = findViewById(R.id.visitor_up);

        score_local = findViewById(R.id.score_local);
        score_visitor = findViewById(R.id.score_visitor);
        ...
        local_yc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(GameActivity.this, "Yellow card to local player", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        local_rc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(GameActivity.this, "Red card to local player", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        visitor_yc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(GameActivity.this, "Yellow card to visitor player", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        visitor_rc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(GameActivity.this, "Red card to visitor player", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        next2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(GameActivity.this, Part2Activity.class);
                startActivity(i);
                next3.bringToFront();
        ...
        next3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(GameActivity.this, Part3Activity.class);
                startActivity(i);
                next4.bringToFront();
        ...
        next4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(GameActivity.this, Part4Activity.class);
                startActivity(i);
    ...
    public void onBackPressed()
    {
        super.onBackPressed();
        Runnable runnable = () -> {
            Intent i = new Intent(GameActivity.this, TeamsActivity.class);
            startActivity(i);
            finish();
        };
